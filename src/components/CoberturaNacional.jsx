...
const CoberturaNacional = () => {
  ...
  return (
    <section className="pt-10 pb-4  md:py-20 bg-gradient-to-r from-black to-[#FEC727] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8 md:mb-16">
          <div className="inline-flex items-center justify-center bg-[#FEC727] bg-opacity-20 p-2 md:px-6 md:py-3 rounded-full mb-6">
            <Globe className="w-6 h-6 mr-2 text-black" />
            <span className="text-xs md:text-lg font-medium text-black">COBERTURA NACIONAL</span>
          </div>
          <h2 className="text-xl md:text-5xl font-bold mb-6 text-white">
            Llegamos a <span className="text-[#FEC727]">20 ciudades</span> del
            Perú
          </h2>
          <p className="text-sm md:text-xl text-white max-w-3xl mx-auto">
            Nuestra red logística cubre las principales rutas del país con
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden md:block">
            <div className="mb-8 flex items-center">
              <Navigation className="w-5 h-5 md:w-10 md:h-10 mr-4 text-[#FEC727]" />
              <div>
                <h3 className="text-lg  md:text-2xl font-bold text-white">
                  Rutas principales y secundarias
                </h3>
                <p className="text-white">
                  Cobertura en costa, sierra y selva del Perú
                </p>
              </div>
            </div>

            <div className=" grid grid-cols-3 sm:grid-cols-2 gap-2 md:gap-4">
              {ciudades.map((ciudad, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`flex items-center p-1  md:p-4 ${color} bg-opacity-50 rounded-lg border hover:shadow-md transition-all `}
                  >
                    <MapPin className="w-5 h-5 mr-1 md:mr-3 text-black flex-shrink-0" />
            ...
            {/* Info adicional */}
            <div className="mt-8 p-3 md:p-6 bg-[#FEC727] bg-opacity-10 rounded-xl border border-[#FEC727] border-opacity-30">  
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg md:text-xl font-bold text-black mb-2">
                    Flota especializada por región
                  </h4>
                  <p className="text-black text-xs">
                    Contamos con vehículos adaptados a cada tipo de terreno y
                    necesidad logística, desde unidades para carretera hasta
                    vehículos para zonas rurales.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Logros */}
        <div className="hidden md:grid grid-cols-2 md:grid-cols-4 gap-6  mt-8 md:mt-16">
