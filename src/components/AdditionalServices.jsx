          ...
          {[
            {
              ...
              icon: (
                <Truck className="w-12 h-12 mb-4 mx-auto" color="#FEC727" />
              ),
            },
            {
              ...
              icon: (
                <Clock className="w-12 h-12 mb-4 mx-auto" color="#FEC727" />
              ),
            },
            {
              ...
              icon: (
                <Award className="w-12 h-12 mb-4 mx-auto" color="#FEC727" />
              ),
            },
          ].map((item, index) => (
            <div
          ...
          {[
            {
              ...
              author: "Julio Villafuerte - Jefe de Transporte",
            ...
            },
            {
              ...
              author: "Jhon Advincula - Supervisor de Transporte",
            ...
            },
            {
              ...
              author: "Juan Llanos - Supervisor de Transporte",
              company: "LA CALERA S.A.C.",
            },
          ].map((testimonial, index) => (
            <div
              key={index}
              className="relative bg-gray-900 p-8 rounded-xl border-l-4 border-yellow-500"
            >
              <Quote
              ...
              <div className="border-t border-gray-700 pt-4">
                <p className="font-semibold" style={{ color: "#FEC727" }}>
                  {testimonial.author}
                </p>
